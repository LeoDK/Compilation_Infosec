...
tokens SYM_VOID SYM_INT SYM_CHAR SYM_AMPERSAND
non-terminals S INSTR INSTRS BLOC ELSE EXPR FACTOR
non-terminals INSTR_DECLARATION_RIGHT INSTR_IDENTIFIER_RIGHT INSTR_IDENTIFIER_LEFT
...
non-terminals FACTOR_ASTERISK_RIGHT FACTOR_AMPERSAND_RIGHT
non-terminals ADD_EXPRS ADD_EXPR
non-terminals MUL_EXPRS MUL_EXPR
non-terminals CMP_EXPRS CMP_EXPR
non-terminals EQ_EXPRS EQ_EXPR
non-terminals TYPE TYPE_RIGHT
axiom S
{
  open Symbols
  open Ast
...
FUNDEF -> TYPE SYM_IDENTIFIER SYM_LPARENTHESIS LPARAMS_DECLARATION SYM_RPARENTHESIS INSTR { Node (Tfundef, [ $1;
                                                                                                    ...
                                                                                                    Node (Tfunargs, $4);
                                                                                                    Node (Tfunbody, [$6]) ]) }
TYPE -> SYM_VOID TYPE_RIGHT { $2 (Node (Ttype, [StringLeaf "void"])) }
TYPE -> SYM_INT TYPE_RIGHT { $2 (Node (Ttype, [StringLeaf "int"])) }
TYPE -> SYM_CHAR TYPE_RIGHT { $2 (Node (Ttype, [StringLeaf "char"])) }
TYPE_RIGHT -> { fun x -> x }
TYPE_RIGHT -> SYM_ASTERISK TYPE_RIGHT { fun x -> Node (Tderef, [$2 x]) }
...
INSTR -> INSTR_IDENTIFIER_LEFT IDENTIFIER INSTR_IDENTIFIER_RIGHT { $3 ($1 $2) }
INSTR_IDENTIFIER_LEFT -> { fun x -> x }
INSTR_IDENTIFIER_LEFT -> SYM_ASTERISK INSTR_IDENTIFIER_LEFT { fun x -> Node (Tderef, [$2 x]) }
...
FACTOR -> INTEGER { $1 }
FACTOR -> CHARACTER { $1 }
FACTOR -> SYM_ASTERISK FACTOR_ASTERISK_RIGHT { Node (Tderef, [$2]) }
FACTOR_ASTERISK_RIGHT -> IDENTIFIER { $1 }
FACTOR_ASTERISK_RIGHT -> SYM_LPARENTHESIS FACTOR_ASTERISK_RIGHT SYM_RPARENTHESIS { $2 }
FACTOR_ASTERISK_RIGHT -> SYM_AMPERSAND FACTOR_AMPERSAND_RIGHT { Node (Taddress, [$2]) }
FACTOR -> SYM_AMPERSAND FACTOR_AMPERSAND_RIGHT { Node (Taddress, [$2]) }
FACTOR_AMPERSAND_RIGHT -> IDENTIFIER { $1 }
FACTOR_AMPERSAND_RIGHT -> SYM_LPARENTHESIS FACTOR_AMPERSAND_RIGHT SYM_RPARENTHESIS { $2 }
FACTOR_AMPERSAND_RIGHT -> SYM_ASTERISK FACTOR_ASTERISK_RIGHT { Node (Tderef, [$2]) }
